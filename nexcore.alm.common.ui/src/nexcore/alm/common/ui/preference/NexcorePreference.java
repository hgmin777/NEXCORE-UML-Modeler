...
/**
* <ui>
* <li>업무 그룹명 : nexcore.tool.core.ui.preference</li>
* <li>서브 업무명 : NexcorePreference.java</li>
* <li>작성자 : 이준석</li>
* <li>작성일 : 2009. 9. 24.</li>
* <li>설 명 : NexcorePreference</li>
* </ui>
*/
public class NexcorePreference extends FieldEditorPreferencePage implements IWorkbenchPreferencePage{

    private IWorkbench workbench;
    
    private Composite nexcoreComposite;
    
    public NexcorePreference() {
        super(GRID);
