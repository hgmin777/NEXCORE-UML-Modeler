 ...
 * <li>설  명 : ConnectionCreationToolForSequenceDiagramRelationship</li>
 * <li>작성일 : 2010. 1. 19.</li>
 * <li>작성자 : 한승일</li>
 * </ul>
 */
public class ConnectionCreationToolForSequenceDiagramRelationship extends
ConnectionCreationToolWithAdditionalInformation implements FocusListener, KeyListener, MouseListener {
    ...
    private boolean handleExtendRelationship(CreateConnectionCommand command) {
        ...
        // }
        // if
        // (!command.getConnection().getRelationType().equals(RelationType.EXTEND))
        // {
        // return true;
        // }
        //
        ...
        //
        // Display display =
        // this.getCurrentViewer().getControl().getShell().getDisplay();
        ...
        // return true;
        // } else {
        // command.setExtensionPoint(useCase.getExtensionPoints().get(selectedIndex
        // - 1));
        // return true;
        // }
