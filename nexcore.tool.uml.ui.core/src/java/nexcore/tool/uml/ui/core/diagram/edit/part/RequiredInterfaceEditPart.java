 ...
 * <li>설 명 : RequiredInterfaceEditPart</li>
 * <li>작성일 : 2011. 3. 4.</li>
 * <li>작성자 : 강경구</li>
 * </ul>
 */
public class RequiredInterfaceEditPart extends AbstractChildCompartmentEditPart {
    ...
    protected List getModelChildren() {
        ...
        NotationNode requiredInterfaces = (NotationNode) this.getModel();
        List<NotationNode> list = new ArrayList<NotationNode>();
        Interface interfaceElement = (Interface) requiredInterfaces.getUmlModel();
        ...
        if (interfaceElement instanceof NamedElement) {
            if (interfaceElement.getName() != null && !interfaceElement.getName().equals(UICoreConstant.EMPTY_STRING)) {
                ...
                nameofUML.setParent(requiredInterfaces);
        ...
        if (showOperation) {
            ...
            for (Operation umlOperation : operationList) {
                ...
                operationModel.setNodeType(NodeType.REQUIRED_INTERFACE_OPERATION);
                operationModel.setParent(requiredInterfaces);
