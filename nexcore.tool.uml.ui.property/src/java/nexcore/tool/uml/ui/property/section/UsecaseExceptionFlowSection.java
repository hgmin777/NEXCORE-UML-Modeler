 ...
 * <li>설  명 : UsecaseExceptionFlowSection</li>
 * <li>작성일 : 2010. 5. 20.</li>
 * <li>작성자 : 황선림</li>
 * </ul>
 */
public class UsecaseExceptionFlowSection extends UsecaseFlowSection {
    ...
    protected void deleteFlow(UseCaseDetail usecaseDetail, Object selectedElement) {
        List<FlowObject> list = usecaseDetail.getExceptionFlowList();
    ...
    protected Object[] getFlowList(UseCase useCase) {
        ...
        if (null != annotation && annotation instanceof UseCaseDetail) {
            ...
            List<FlowObject> subFlows = detail.getExceptionFlowList();
            if (!subFlows.isEmpty()) {
    ...
    protected void setFlowList() {
        ...
        if (null != annotation) {
            ...
            detail.getExceptionFlowList().add(flowObject);
