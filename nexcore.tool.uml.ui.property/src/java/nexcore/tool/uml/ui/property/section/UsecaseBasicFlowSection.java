 ...
 * <li>설  명 : UsecaseBasicFlowSection</li>
 * <li>작성일 : 2010. 5. 20.</li>
 * <li>작성자 : 황선림</li>
 * </ul>
 */
public class UsecaseBasicFlowSection extends UsecaseFlowSection {
    ...
    protected void setFlowList() {
        ...
        if (null != annotation) {
            ...
            detail.getBasicFlowList().add(flowObject);
    ...
    protected Object[] getFlowList(UseCase useCase) {
        ...
        if (null != annotation && annotation instanceof UseCaseDetail) {
            UseCaseDetail detail = (UseCaseDetail) annotation;
            List<FlowObject> basicFlows = detail.getBasicFlowList();
            if (!basicFlows.isEmpty()) {
                flowList.addAll(basicFlows);
            }
        }
    ...
    protected void moveDown(UseCaseDetail usecaseDetail, Object selectedElement) {
        ...
        List<FlowObject> list = usecaseDetail.getBasicFlowList();
