 ...
 * <li>설  명 : UsecasePostconditionSection</li>
 * <li>작성일 : 2010. 5. 19.</li>
 * <li>작성자 : 황선림</li>
 * </ul>
 */
public class UsecasePostconditionSection extends TemplateTextSection {
    ...
    protected String get() {
        ...
        if (annotation != null && annotation instanceof UseCaseDetail) {
            return ((UseCaseDetail) annotation).getPostCondition();
        }
    ...
    protected String getLabelText() {
        return UMLMessage.LABEL_POSTCONDITION;
    }
    ...
    protected void set(String value) {
        try {
            ...
            if (null == annotation) {
                ...
                detail.setPostCondition(value);
                getData().getEAnnotations().add(detail);

            } else {
                if (annotation instanceof UseCaseDetail) {
                    ((UseCaseDetail) annotation).setPostCondition(value);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
