 ...
 * <li>설  명 : UsecaseRealizationReportHandler</li>
 * <li>작성일 :  2010. 11. 3.</li>
 * <li>작성자 : 오은주</li>
 * </ul>
 */
public class UsecaseRealizationReportHandler extends ReportHandler {
     ...
     * @param projectName
     */
    public UsecaseRealizationReportHandler(String reportLocation, IFile templateFile,
    ...
    protected void createReportData(Model model) {
        jobMonitor.startTask(UMLMessage.LABEL_CREATE_USECASE_DESIGN, this.selectedPackageList.size());
        ...
        if (null != packageUsecaseRealization) {
            navigatePackage(usecaseRealizationContentManager, this.rootModel, packageUsecaseRealization);
        }
        jobMonitor.endTask();
    }
    ...
    protected String getDefaultTemplateFileName() {
        return UICoreConstant.TEMPLATE_XML_USECASE_ARCHITECTURE_XML;
    }
