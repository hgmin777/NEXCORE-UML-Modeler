...
import nexcore.tool.uml.ui.project.report.control.impl.UsecaseAnalysisReportHandler;
 ...
 * <li>설  명 : UsecaseAnalysisToXMLFileAction</li>
 * <li>작성일 : 2010. 11. 3.</li>
 * <li>작성자 : 오은주</li>
 * </ul>
 */
public class UsecaseAnalysisToXMLFileAction extends CommonReportAction {
    ...
    protected String getTitle() {
        return UMLMessage.LABEL_EXPORT_USECASE_ANALYSIS_SPECIFICATION_TO_DOC;
    }
    ...
    protected ReportHandler getReportHandler(String reportLocation, IFile templateFile, List<Element> selectedPackage,
                                             String projectName) {
        return new UsecaseAnalysisReportHandler(reportLocation, templateFile, selectedPackage, projectName);
    }
