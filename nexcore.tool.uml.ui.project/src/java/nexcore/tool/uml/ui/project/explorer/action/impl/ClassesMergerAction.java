...
import nexcore.tool.uml.ui.project.explorer.command.impl.ClassesMergerCommand;
 ...
 * <li>설 명 : ClassesMergerAction</li>
 * <li>작성일 : 2010. 12. 2.</li>
 * <li>작성자 : 최윤석</li>
 * </ul>
 */
public class ClassesMergerAction extends AbstractUMLExplorerExtendedAction {
    ...
    public String getTaskName() {
        return UMLMessage.LABEL_CLASSES_MERGER;
    }
    ...
    public CompoundCommand configureCommand(IProgressMonitor monitor) {
        ...
        if (getDomain() != null && getSelectedElementList() != null && getShell() != null && monitor != null) {
            command = new ClassesMergerCommand(getDomain(), getSelectedElementList(), getShell(), monitor);
        }
