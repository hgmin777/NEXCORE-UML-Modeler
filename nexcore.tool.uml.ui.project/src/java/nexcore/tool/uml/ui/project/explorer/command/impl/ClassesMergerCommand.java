...
import nexcore.tool.uml.ui.core.dialog.MergeClassDialog;
 ...
 * <li>설 명 : ClassesMergerCommand</li>
 * <li>작성일 : 2010. 12. 2.</li>
 * <li>작성자 : 최윤석</li>
 * </ul>
 */
public class ClassesMergerCommand extends UMLExplorerExtendedCommand {
     ...
     * @param monitor
     */
    public ClassesMergerCommand(TransactionalEditingDomain domain, List<Element> selectedElementList,
    ...
    protected void doExecute() {
        MergeClassDialog dialog = new MergeClassDialog(parentShell,
        ...
        if (dialog.getFirstResult() != null && dialog.getClassName() != null) {
            semanticModelHandler.initializeClassesMerger(dialog.getFirstResult(),
                dialog.getClassName(),
                dialog.isClear());
        }
