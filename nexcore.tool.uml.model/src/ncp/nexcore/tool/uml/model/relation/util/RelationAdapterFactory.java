 ...
 */
package nexcore.tool.uml.model.relation.util;
 ...
 * <li>서브 업무명 : nexcore.tool.uml.model.relation.util</li>
 * <li>설  명 : RelationAdapterFactory</li>
 * <li>작성일 : 2015. 10. 6.</li>
 * <li>작성자 : 탁희수 </li>
 * </ul>
 */
public class RelationAdapterFactory extends AdapterFactoryImpl {
    ...
    protected RelationSwitch<Adapter> modelSwitch =
        new RelationSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseRelationMap(Map.Entry<Element, EList<Element>> object) {
                return createRelationMapAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link nexcore.tool.uml.model.relation.Relation <em>Relation</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>Map</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createRelationMapAdapter() {
        return null;
    }
