 ...
 * <li>설  명 : ProjectInformationSwitch</li>
 * <li>작성일 : 2015. 10. 6.</li>
 * <li>작성자 : 탁희수 </li>
 * </ul>
 * @param <T>
 */
public class ProjectInformationSwitch<T> {
    /**
     ...
     * @generated
     */
    public ProjectInformationSwitch() {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case ProjectInformationPackage.PROJECT_ELEMENT: {
                ...
                if (result == null)
                    result = caseEAnnotation(projectElement);
                if (result == null)
                    result = caseEModelElement(projectElement);
                if (result == null)
     ...
     * <em>Project Element</em>'. <!-- begin-user-doc --> This implementation
