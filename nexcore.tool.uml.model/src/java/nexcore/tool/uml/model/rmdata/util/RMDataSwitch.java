 ...
 * <li>설  명 : RMDataSwitch</li>
 * <li>작성일 : 2015. 10. 6.</li>
 * <li>작성자 : 탁희수 </li>
 * </ul>
 * @param <T>
 */
public class RMDataSwitch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case RMDataPackage.RM_DATA: {
                RMData rmData = (RMData) theEObject;
                T result = caseRMData(rmData);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case RMDataPackage.RM_OBJECT: {
                RMObject rmObject = (RMObject) theEObject;
                T result = caseRMObject(rmObject);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
     ...
     * <em>RM Data</em>'. <!-- begin-user-doc --> This implementation returns
     ...
     * @generated
     */
    public T caseRMData(RMData object) {
        return null;
    }

    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>RM Object</em>'. <!-- begin-user-doc --> This implementation returns
     * null; returning a non-null result will terminate the switch. <!--
     * end-user-doc -->
     * 
     * @param object
     ...
     * @generated
     */
    public T caseRMObject(RMObject object) {
        return null;
    }
