 ...
 * <li>설  명 : CollapsedLabel</li>
 * <li>작성일 : 2015. 10. 6.</li>
 * <li>작성자 : 탁희수 </li>
 * </ul>
 */
public class CollapsedLabel extends Figure implements PositionConstants {
     ...
     * text
     */
    private String text = UICoreConstant.PROJECT_CONSTANTS__EMPTY_STRING;
     ...
     * @since 2.0
     */
    public CollapsedLabel(String s) {
        setText(s);
    }
     ...
     * @since 2.0
     */
    public CollapsedLabel(String s, Image i) {
        setText(s);
        setIcon(i);
    }
    ...
    protected Dimension calculateLabelSize(Dimension txtSize) {
        ...
        if (getIcon() == null || UICoreConstant.PROJECT_CONSTANTS__EMPTY_STRING.equals(getText()))
            gap = 0;
    ...
    private void calculatePlacement() {
        int gap = getIconTextGap();
        if (icon == null || UICoreConstant.PROJECT_CONSTANTS__EMPTY_STRING.equals(text))
            gap = 0;
        Insets insets = getInsets();
     ...
     * collapsedText
     */
    private String collapsedText = UICoreConstant.PROJECT_CONSTANTS__EMPTY_STRING;
    ...
    public String getSubStringText() {
        ...
        int dotsWidth = getTextUtilities().getTextExtents(UICoreConstant.PROJECT_CONSTANTS__BLANK, currentFont).width;
        ...
        if (subStringLength < text.length()) {
            collapsedText = new String(text.substring(subStringLength, text.length()));
            // if(! this.getParent().getChildren().contains(this.childLabel)){
            // this.getParent().add(this.childLabel);
            // }
        } else {
            collapsedText = UICoreConstant.PROJECT_CONSTANTS__EMPTY_STRING;
            // if(this.getParent().getChildren().contains(this.childLabel)){
            // this.getParent().getChildren().remove(this.childLabel);
            // }
        }

        this.childLabel.setText(collapsedText);
        return subStringText;
    }
     ...
     * setChildLabel
     *  
     * @param childLabel void
     */
    public void setChildLabel(Label childLabel) {
    ...
    public void setText(String s) {
        ...
        if (s == null)
            s = UICoreConstant.PROJECT_CONSTANTS__EMPTY_STRING;
        if (text.equals(s))
            return;
        text = s;
        revalidate();
