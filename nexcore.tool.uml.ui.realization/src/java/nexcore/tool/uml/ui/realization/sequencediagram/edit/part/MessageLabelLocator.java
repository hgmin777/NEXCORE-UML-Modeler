 ...
 * <li>설 명 : MessageLabelLocator</li>
 * <li>작성일 : 2010. 1. 19.</li>
 * <li>작성자 : ytchoi</li>
 * </ul>
 */
public class MessageLabelLocator extends ConnectionEndpointLocator {
     ...
     * @param isEnd
     */
    public MessageLabelLocator(PolylineConnection connection, LabelType type, boolean isEnd) {
