 ...
 * <li>설  명 : SequenceBendpointEditPolicy</li>
 * <li>작성일 : 2011. 6. 9.</li>
 * <li>작성자 : zerotae</li>
 * </ul>
 */
public abstract class SequenceBendpointEditPolicy
...
private List createHandlesForAutomaticBendpoints() {
    ...
    for (int i = 0; i < points.size() - 1; i++)
        list.add(new SequenceBendpointCreationHandle(connEP, 0, i));
...
private List createHandlesForUserBendpoints() {
    ...
    for (int i = 0; i < points.size() - 1; i++) {
        ...
        list.add(new SequenceBendpointCreationHandle(connEP, bendPointIndex, i));
        ...
        if (i < points.size() - 1
            ...
            list.add(new SequenceBendpointCreationHandle(connEP, bendPointIndex, i + 1));
