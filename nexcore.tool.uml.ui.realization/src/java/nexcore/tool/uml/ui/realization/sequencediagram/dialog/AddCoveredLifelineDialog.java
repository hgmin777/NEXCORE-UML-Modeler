 ...
 * <li>설 명 : AddCoveredLifelineDialog</li>
 * <li>작성일 : 2010. 2. 22.</li>
 * <li>작성자 : ytchoi</li>
 * </ul>
 */
public class AddCoveredLifelineDialog extends Dialog {
     ...
     * @param type
     */
    public AddCoveredLifelineDialog(Shell parentShell, List<Lifeline> lifelineList, boolean isSelectAll) {
        super(parentShell);
