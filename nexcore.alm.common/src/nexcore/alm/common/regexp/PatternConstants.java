 ...
 * PatternConstants.java</li> <li>작성자 : 박수용</li> <li>작성일 : 2008. 12. 18</li> <li>
 * 설 명 : PatternConstants</li> </ui>
 */
public interface PatternConstants {

    // java convention 명명법 관련
    public static final String[] SPECIAL_CHAR_LABELS = { "~", "!", "@", "#", "$", "%", "^", "&&", "*", ":" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$

    /**
     * abstract class
     */
    public static final String AbstractClassName = "^Abstract.*$|^.*Factory$"; //$NON-NLS-1$

    /**
     * constants (static, final fields)
     */
    public static final String ConstantName = "^[A-Z][A-Z0-9]*(_[A-Z0-9]+)*$"; //$NON-NLS-1$

    /**
     * local, non-final variables
     */
    public static final String FiedlName = "^[a-z][a-zA-Z0-9]*$"; //$NON-NLS-1$

    /**
     * methods
     */
    public static final String MethodName = "^[a-z][a-zA-Z0-9]*$"; //$NON-NLS-1$

    /**
     * packages
     */
    public static final String PackageName = "^[a-z]+(/.[a-zA-Z_][a-zA-Z0-9_]*)*$"; //$NON-NLS-1$

    /**
     * parameters
     */
    public static final String ParameterName = "^[a-z][a-zA-Z0-9]*$"; //$NON-NLS-1$

    /**
     * static, non-final fields
     */
    public static final String StaticVariableName = "^[a-z][a-zA-Z0-9]*$"; //$NON-NLS-1$

    /**
     * classes and interfaces
     */
    public static final String TypeName = "^[A-Z][a-zA-Z0-9]*$"; //$NON-NLS-1$
     ...
     * Pro*C용 XSQL에서 : 패턴
     */
    public static final String SQL_COLON_PARAMETER = ":[^\\s]+"; //$NON-NLS-1$
    
    public static final String[] REG_EXP_KEYWORD = {
        "*", ".", "{", "}", "(", ")", "^", "[", "]", "-", "|", "&", "\\d", "\\D", "\\s", "\\S", "\\w", "\\W", "\\b", "\\B", "\\A", "\\z", "\\Z", "+", "?" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$ //$NON-NLS-10$ //$NON-NLS-11$ //$NON-NLS-12$ //$NON-NLS-13$ //$NON-NLS-14$ //$NON-NLS-15$ //$NON-NLS-16$ //$NON-NLS-17$ //$NON-NLS-18$ //$NON-NLS-19$ //$NON-NLS-20$ //$NON-NLS-21$ //$NON-NLS-22$ //$NON-NLS-23$
