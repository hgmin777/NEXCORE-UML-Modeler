...
public class Base64 {
    ...
    private static final byte PADDING_CHAR_ENC = -1; // Indicates padding char
                                                     // in encoding
     ...
     **/
    private static final byte[] STANDARD_DECODABET = { -9, -9, -9, -9, -9, -9, -9, -9, -9, // Decimal
                                                                                           // 0
                                                                                           // -
                                                                                           // 8
     ...
     */
    private static final byte[] URL_SAFE_DECODABET = { -9, -9, -9, -9, -9, -9, -9, -9, -9, // Decimal
                                                                                           // 0
                                                                                           // -
                                                                                           // 8
        -5, -5, // Whitespace: Tab and Linefeed
    ...
    /**
     * Create a new Base64 encoder and decoder using the standard Base64
     * alphabet. Note that the resulting encoded strings are not
     * <i>URL-safe</i>: they will can contain characters that are subject to URL
     * encoding.
     */
    public Base64() {
        this(false);
     ...
     * in Section 4 of RFC3548: <a
     * href="http://www.faqs.org/rfcs/rfc3548.html">http
     * ://www.faqs.org/rfcs/rfc3548.html</a>. When URL-safe encoding is used,
     * the standard "=" Base64 padding character is replaced with the '.'
     * character.
     * <p>
     ...
     * 
     * @param urlSafe
     *            if true, URL safe encoding and decoding will be used
     */
    ...
    /**
     * Returns whether or not this coder is using Base64-like encoding that is
     * URL- and Filename-safe as described in Section 4 of RFC3548: <a
     * href="http://www.faqs.org/rfcs/rfc3548.html"
     * >http://www.faqs.org/rfcs/rfc3548.html</a>. When URL-safe encoding is
     * used, the standard "=" Base64 padding character is replaced with the '.'
     * character.
     * <p>
     * It is important to note that data encoded this way is <em>not</em>
     * officially valid Base64, or at the very least should not be called Base64
    ...
    /**
     * Encodes a byte array into Base64 notation. The resulting string will be
     * created using the platform default encoding.
     * 
     * @param source
    ...
    /**
     * Decodes data from Base64 notation. Uses the platform default character
     * set to obtain bytes from given string.
     * 
     * @param s
